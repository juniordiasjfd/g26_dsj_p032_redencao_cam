...
const oedCode = "dDKcKUn2oLWz73B3";
...
(function(){const oedCode = "dDKcKUn2oLWz73B3";
...
const oedCode = "dDKcKUn2oLWz73B3";
const modalText = "<p tabindex='0' style='font-family: var(--fontFamilySubtitleBold); font-weight: 600; margin: 0;'>Créditos</p><p style=\"text-align:justify;\">Background: &nbsp;<i>A Redenção de Cam</i>, óleo sobre tela de Modesto Brocos y Gómez, 1895 (199 cm x 166 cm).</p><p style=\"text-align:justify;\">Reprodução/Museu Nacional de Belas Artes, Rio de Janeiro, RJ.</p>";
const btnId = "npoed_credits-button-dDKcKUn2oLWz73B3";
...
(function(){const customId = "npoed_modal-dDKcKUn2oLWz73B3";
